    ...
    <Container>
      <div className="py-16 md:py-36">
        <Fade bottom distance={`24px`}>
          <h2 className="text-dersu-lg leading-dersu-lg mb-10 md:mb-16 md:text-dersu-xl md:leading-dersu-xl md:w-9/12">
          ...
          <p className="text-dersu-sm leading-dersu-sm md:text-dersu-lg md:leading-dersu-lg font-light md:w-8/12">
