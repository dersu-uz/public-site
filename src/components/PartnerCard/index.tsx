    ...
    hasChildren ? 
        ...
        isLinkedCard ? 
            <a
                ...
                rel={linkRel}
                onClick={onClick}
                className="bg-white rounded-lg flex flex-col px-5 border-transparent border-4 hoverable:hover:border-dersu-blue"
            >
                {moreInfo === true && (
                    <div>
            ...
            <div className="cursor-pointer bg-white rounded-lg flex flex-col px-5 border-transparent border-4 hoverable:hover:border-dersu-blue" onClick={onClick}>
                {moreInfo === true && (
                    <div>
                        <p className="h-[210px] flex justify-center items-center">
                            <img
