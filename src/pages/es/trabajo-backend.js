    ...
    <DefaultLayout>
      <MarkdownContent>
        ...
        <p>
          ...
          soporte en tiempo real de rutas en la montaña y la naturaleza. Más
          información en{' '}
        ...
        <ul>
          <li>
            ...
            aludes, etc. y ofrecerlas de una forma coherente a la aplicación
            móvil a través de una API única.
          </li>
          <li>
        ...
        <p>
          ...
          semana laboral de 40 horas o menos (estamos abiertos a medias
